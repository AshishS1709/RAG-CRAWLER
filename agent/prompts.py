...
the most relevant information in a Python documentation knowledge base.

Rules:
- Keep the rewritten query concise (1-2 sentences maximum)
- Preserve the original intent
- Add relevant Python/programming terminology if helpful
...
GRADE_DOCUMENT_SYSTEM = """You are a relevance grader for a Python documentation RAG system.
...
NO_DOCS_RESPONSE = (
    "I don't have enough information in the Python documentation knowledge base "
    "to answer this question. The crawled content may not cover this topic, or "
    "the question may be outside the scope of Python docs.\n\n"
    "**Suggestion**: Try rephrasing your question or consult "
    "https://docs.python.org/3/ directly."
)
